...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 04, 2024 lúc 06:59 PM
...
(1, 'name', 'MT-SHOP'),
(2, 'description', 'Thương hiệu thời trang nam MT Chuyên các dòng sản phẩm thời trang nam: Quần jean, quần tây, quần kaki, áo sơ mi, áo khoác, áo vest, áo thun, phụ kiện nam,...'),
(3, 'logo_header', 'image/logoMT.jpg'),
(4, 'logo_footer', 'image/logoMT.jpg'),
(5, 'email', 'MTShop@gmail.com.vn'),
(6, 'phone', '0327367159'),
(7, 'adress', '$%^$%^ 14 Trần Văn Trà, quận 7, Thành Phố Hồ Chí Minh'),
(15, 'slider', 'image/g144.jpg image/g137.jpg image/g142.jpg image/g143.jpg image/g116.jpg'),
(16, 'fb', 'https://www.facebook.com/m.truongnobita'),
...
(24, 'category_4', '18'),
(25, 'gioithieu', '<p>&nbsp;</p>\n\n<p><strong>Thương hiệu Thời trang MT&nbsp;được th&agrave;nh lập từ th&aacute;ng 3 năm 2010, l&agrave; một trong những thương hiệu thời trang nam uy t&iacute;n h&agrave;ng đầu Việt Nam. Với sự quản l&yacute; chặt chẽ, chuy&ecirc;n nghiệp của đội ngũ&nbsp;quản l&yacute;; Nỗ lực s&aacute;ng tạo kh&ocirc;ng ngừng của bộ phận thiết kế, Sự tận t&acirc;m của nh&acirc;n vi&ecirc;n b&aacute;n h&agrave;ng&hellip; l&agrave; những yếu tố l&agrave;m n&ecirc;n thương hiệu thời trang MT&nbsp;lớn mạnh như hiện nay.</strong></p>\n\n<p>&nbsp;</p>\n\n<p><strong>MT&nbsp;lu&ocirc;n quan niệm thời trang l&agrave; sự t&igrave;m t&ograve;i v&agrave; s&aacute;ng tạo n&ecirc;n những sản phẩm của MT&nbsp;đều được thiết kế ri&ecirc;ng với sự trẻ trung, hiện đại để mang lại gu&nbsp;thời trang hợp mốt nhất cho c&aacute;c bạn trẻ. C&aacute;c d&ograve;ng sản phẩm của MT&nbsp;kh&ocirc;ng ngừng đa dạng về kiểu d&aacute;ng, mẫu m&atilde; từ &aacute;o sơ mi, &aacute;o thun, &aacute;o kho&aacute;c, &aacute;o vest, quần jean, quần t&acirc;y, quần kaki&hellip; đến c&aacute;c phụ kiện thời trang v&ocirc; c&ugrave;ng s&agrave;nh điệu, tất cả tạo n&ecirc;n vẻ đẹp ho&agrave;n hảo, hiện đại, phong c&aacute;ch cho ph&aacute;i mạnh</strong></p>\n\n<p>&nbsp;</p>\n\n<p><strong>B&ecirc;n cạnh đ&oacute; MT&nbsp;lu&ocirc;n đặt m&igrave;nh v&agrave;o t&acirc;m l&yacute; v&agrave; quyền lợi của kh&aacute;ch h&agrave;ng để tung ra những sản phẩm thời trang chất lượng tốt nhất, mẫu m&atilde; cực đẹp, mới lạ nhưng với gi&aacute; cả cực k&igrave; hấp dẫn, cạnh tranh nhất.</strong></p>\n\n<p>&nbsp;</p>\n\n<p><strong>Hiện nay, thương hiệu thời trang nam MT&nbsp;ph&aacute;t triển ng&agrave;y c&agrave;ng lớn mạnh th&agrave;nh một hệ thống với nhiều chi nh&aacute;nh cửa h&agrave;ng b&aacute;n lẻ tại TPHCM, Đồng Nai v&agrave; Vũng T&agrave;u. Ngo&agrave;i ra, nhằm tạo sự tiện lợi mua sắm tối đa cho kh&aacute;ch h&agrave;ng, MT&nbsp;ph&aacute;t triển hệ thống b&aacute;n h&agrave;ng online, giao h&agrave;ng đến tận tay người ti&ecirc;u d&ugrave;ng tr&ecirc;n to&agrave;n quốc. Giờ đ&acirc;y ngay tại nh&agrave; bạn cũng c&oacute; thể chọn cho m&igrave;nh những sản phẩm ph&ugrave; hợp với sở th&iacute;ch v&agrave; phong c&aacute;ch của m&igrave;nh.</strong></p>\n\n<p>&nbsp;</p>\n\n<p><strong>Đến với MT-SHOP, ch&uacute;ng t&ocirc;i lu&ocirc;n tận t&acirc;m tư vấn gi&uacute;p qu&yacute; kh&aacute;ch t&igrave;m được những sản phẩm y&ecirc;u th&iacute;ch, ph&ugrave; hợp với nhu cầu v&agrave; g&oacute;p phần tạo n&ecirc;n phong c&aacute;ch cho ri&ecirc;ng m&igrave;nh!</strong></p>\n');
...
(7, 'truong', '21232f297a57a5a743894a0e4a801fc3', 'Nguyễn Mạnh Trường', '2004-08-22', '362489844', 'Tiền Giang', '0327367159', '2210010079.truong@ctim.edu.vn', '0', 1),
(10, 'thanhphat', '21232f297a57a5a743894a0e4a801fc3', 'Lê Thanh Phát', '2004-02-02', '123456789', 'Nguyễn Văn Cừ', '0327367159', '2210010079.truong@ctim.edu.vn', '1', 1);
